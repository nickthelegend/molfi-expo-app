...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontFamily: 'Syne-Bold', fontSize: 20, color: '#fff' },
  headerRight: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  username: { fontFamily: 'Syne-Regular', fontSize: 13, color: 'rgba(255,255,255,0.5)' },
  heroSection: { alignItems: 'center', paddingVertical: 32 },
  heroLabel: { fontFamily: 'Syne-Regular', fontSize: 12, color: 'rgba(255,255,255,0.3)', marginBottom: 8 },
  heroBalance: { fontFamily: 'DM-Mono-Regular', fontSize: 48, color: '#fff', marginBottom: 12 },
  badge: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20 },
  badgeText: { fontFamily: 'DM-Mono-Regular', fontSize: 12 },
  ...
  actionLabel: { fontFamily: 'Syne-Regular', fontSize: 11, color: 'rgba(255,255,255,0.4)' },
  ...
  tabBtnText: { fontFamily: 'Syne-Medium', fontSize: 13, color: 'rgba(255,255,255,0.4)' },
  tabBtnTextActive: { color: '#fff' },
  contentArea: { paddingHorizontal: 20, marginTop: 32 },
  sectionTitle: { fontFamily: 'Syne-Bold', fontSize: 16, color: '#fff', marginBottom: 16 },
  ...
  tokenIconText: { color: '#fff', fontFamily: 'Syne-Bold', fontSize: 18 },
  tokenInfo: { flex: 1, marginLeft: 12 },
  tokenSymbol: { fontFamily: 'Syne-Bold', fontSize: 15, color: '#fff' },
  tokenAmount: { fontFamily: 'DM-Mono-Regular', fontSize: 12, color: 'rgba(255,255,255,0.4)', marginTop: 2 },
  tokenValues: { alignItems: 'flex-end' },
  tokenValueUsd: { fontFamily: 'DM-Mono-Regular', fontSize: 15, color: '#fff' },
  ...
  emptyText: { fontFamily: 'Syne-Regular', fontSize: 14, color: 'rgba(255,255,255,0.3)', textAlign: 'center' },
  ...
  agentAvatarText: { color: '#fff', fontFamily: 'Syne-Bold', fontSize: 18 },
  agentName: { fontFamily: 'Syne-Bold', fontSize: 16, color: '#fff' },
  agentAddr: { fontFamily: 'DM-Mono-Regular', fontSize: 11, color: 'rgba(255,255,255,0.3)', marginTop: 2 },
  ...
  aumLabel: { fontFamily: 'Syne-Regular', fontSize: 13, color: 'rgba(255,255,255,0.4)' },
  aumValue: { fontFamily: 'DM-Mono-Regular', color: '#fff' },
  pnlText: { fontFamily: 'DM-Mono-Regular', fontSize: 14 },
  receiveSheet: { alignItems: 'center', gap: 24 },
  sheetTitle: { fontFamily: 'Syne-Bold', fontSize: 20, color: '#fff' },
  ...
  addressText: { flex: 1, fontFamily: 'DM-Mono-Regular', fontSize: 12, color: 'rgba(255,255,255,0.7)' },
  qrDesc: { fontFamily: 'Syne-Regular', fontSize: 13, color: 'rgba(255,255,255,0.4)', textAlign: 'center', lineHeight: 20 },
  closeBtn: { width: '100%', height: 56, borderRadius: 28, justifyContent: 'center', alignItems: 'center', marginTop: 12 },
  closeBtnText: { fontFamily: 'Syne-Bold', fontSize: 16, color: '#fff' },
  retryBtn: { marginTop: 16, paddingHorizontal: 20, paddingVertical: 10, borderRadius: 12, backgroundColor: 'rgba(255,255,255,0.05)' },
  retryText: { fontFamily: 'Syne-Medium', fontSize: 13, color: '#fff' }
});
