...
const styles = StyleSheet.create({
  ...
  subtitle: { fontFamily: 'Syne-Regular', fontSize: 14, color: 'rgba(255,255,255,0.4)', marginTop: 4 },
  ...
  statItem: { flex: 1 },
  statLabel: { fontFamily: 'Syne-Regular', fontSize: 11, color: 'rgba(255,255,255,0.3)', marginBottom: 4 },
  ...
  footerText: { fontFamily: 'Syne-Regular', fontSize: 12, color: 'rgba(255,255,255,0.3)' },
  ...
  emptySubtitle: { fontFamily: 'Syne-Regular', fontSize: 15, color: 'rgba(255,255,255,0.4)', textAlign: 'center', lineHeight: 22, marginBottom: 32 },
