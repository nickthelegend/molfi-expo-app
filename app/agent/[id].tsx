...
const styles = StyleSheet.create({
  ...
  avatarText: { color: '#fff', fontFamily: 'Syne_700Bold', fontSize: 32 },
  name: { fontFamily: 'Syne_700Bold', fontSize: 24, color: '#fff', marginBottom: 8 },
  statusBadge: { backgroundColor: 'rgba(255,255,255,0.05)', paddingHorizontal: 12, paddingVertical: 4, borderRadius: 12 },
  statusText: { fontFamily: 'Syne_600SemiBold', fontSize: 12, color: 'rgba(255,255,255,0.4)', textTransform: 'capitalize' },
  ...
  statLabel: { fontFamily: 'KHTeka', fontSize: 12, color: 'rgba(255,255,255,0.3)', marginBottom: 8 },
  statValue: { fontFamily: 'DMMono_400Regular', fontSize: 18, color: '#fff' },
  sectionTitle: { fontFamily: 'Syne_700Bold', fontSize: 18, color: '#fff', marginBottom: 16 },
  ...
  tradeType: { fontFamily: 'Syne_600SemiBold', fontSize: 14, color: '#fff' },
  tradeTime: { fontFamily: 'KHTeka', fontSize: 12, color: 'rgba(255,255,255,0.3)' },
  tradeDetails: { flexDirection: 'row', justifyContent: 'space-between' },
  tradeAmount: { fontFamily: 'DMMono_400Regular', fontSize: 14, color: 'rgba(255,255,255,0.6)' },
  tradePnL: { fontFamily: 'DMMono_400Regular', fontSize: 14 },
  emptyState: { padding: 40, alignItems: 'center' },
  emptyText: { fontFamily: 'KHTeka', fontSize: 14, color: 'rgba(255,255,255,0.2)' }
});
