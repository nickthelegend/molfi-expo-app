...
- 0G Mainnet (Chain ID 16601): USDC (0x627d32C41D35284050b168925501867160965383), USDT (0xc2132D05D31c914a87C6611C10748AEb04B58e8F), WETH (0x1Cd0690fF9a693f5EF2dD976660a8dAFc81A109c).
- Polygon (Chain ID 137): USDC (0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174), USDT (0xc2132D05D31c914a87C6611C10748AEb04B58e8F).

For swaps between tokens on the SAME chain (e.g. USDC to USDT on 0G), use action "swap" with matching "fromChain" and "toChain" IDs.
IMPORTANT: 0G Mainnet supports high-speed native swaps for USDC, USDT, and A0GI. Always prioritize native swaps for these pairs on 0G.
