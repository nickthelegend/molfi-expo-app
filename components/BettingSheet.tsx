...
const styles = StyleSheet.create({
  ...
  sideBadgeText: { fontFamily: 'Syne_700Bold', fontSize: 16 },
  headerPrice: { fontFamily: 'DM Mono', fontSize: 16, color: '#fff' },
  marketQuestion: { fontFamily: 'KHTeka', fontSize: 13, color: 'rgba(255,255,255,0.6)', lineHeight: 20, marginBottom: 4 },
  marketEnds: { fontFamily: 'DM Mono', fontSize: 11, color: 'rgba(255,255,255,0.3)', marginBottom: 24 },
  ...
  toggleText: { fontFamily: 'Syne_600SemiBold', fontSize: 13, color: 'rgba(255,255,255,0.4)' },
  toggleTextActive: { color: '#fff' },
  inputSection: { alignItems: 'center', marginBottom: 24 },
  dollarInputRow: { flexDirection: 'row', alignItems: 'center' },
  dollarSymbol: { fontFamily: 'Syne_700Bold', fontSize: 36, color: '#fff', marginRight: 8 },
  mainInput: { fontFamily: 'Syne_700Bold', fontSize: 36, color: '#fff', minWidth: 100 },
  shareEstimation: { fontFamily: 'DM Mono', fontSize: 13, color: 'rgba(255,255,255,0.3)', marginTop: 8 },
  ...
  amtChipText: { fontFamily: 'DM Mono', fontSize: 12, color: 'rgba(255,255,255,0.7)' },
  limitInputRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 },
  limitLabel: { fontFamily: 'KHTeka', fontSize: 14, color: 'rgba(255,255,255,0.5)' },
  limitInputWrapper: { backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, paddingHorizontal: 12, paddingVertical: 8, width: 100 },
  limitInput: { fontFamily: 'DM Mono', fontSize: 15, color: '#fff', textAlign: 'right' },
  summaryCard: { backgroundColor: 'rgba(255,255,255,0.03)', borderRadius: 16, padding: 16, gap: 12, marginBottom: 24 },
  summaryRow: { flexDirection: 'row', justifyContent: 'space-between' },
  summaryLabel: { fontFamily: 'KHTeka', fontSize: 12, color: 'rgba(255,255,255,0.4)' },
  summaryValue: { fontFamily: 'DM Mono', fontSize: 13, color: '#fff' },
  footer: { marginTop: 'auto', gap: 16 },
  balanceText: { fontFamily: 'KHTeka', fontSize: 12, color: 'rgba(255,255,255,0.3)', textAlign: 'center' },
  balanceValue: { color: '#fff', fontFamily: 'DM Mono' },
  confirmBtn: { height: 56, borderRadius: 16, justifyContent: 'center', alignItems: 'center' },
  confirmBtnText: { fontFamily: 'Syne_700Bold', fontSize: 16, color: '#fff' },
  successState: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 40 },
  successTitle: { fontFamily: 'Syne_700Bold', fontSize: 20, color: '#fff', marginTop: 24, marginBottom: 12 },
  orderIdPill: { backgroundColor: 'rgba(255,255,255,0.05)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, marginBottom: 40 },
  orderIdText: { fontFamily: 'DM Mono', fontSize: 12, color: 'rgba(255,255,255,0.4)' },
  doneBtn: { width: '100%', height: 56, borderRadius: 16, justifyContent: 'center', alignItems: 'center' },
  doneBtnText: { fontFamily: 'Syne_700Bold', fontSize: 16, color: '#fff' },
});
