...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontFamily: 'Syne_700Bold', fontSize: 10, letterSpacing: 1 },
  headerLogo: { fontFamily: 'Syne_700Bold', fontSize: 10 },
  dropdownRow: { flexDirection: 'row', marginBottom: 20 },
  dropdownLabel: { fontSize: 8, fontFamily: 'Syne_700Bold', marginBottom: 4 },
  dropdown: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 10, borderRadius: 12, borderWidth: 1 },
  dropdownText: { fontSize: 12, fontFamily: 'KHTeka' },
  assetContainer: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 },
  assetSide: { flex: 1 },
  assetLabel: { fontSize: 9, fontFamily: 'Syne_700Bold', marginBottom: 4 },
  ...
  aiTitle: { fontSize: 8, fontFamily: 'Syne_700Bold' },
  aiText: { fontSize: 11, fontFamily: 'KHTeka', lineHeight: 15 },
  errorBanner: { flexDirection: 'row', alignItems: 'center', padding: 10, borderRadius: 12, marginBottom: 16, gap: 8 },
  errorText: { fontSize: 11, fontFamily: 'KHTeka', flex: 1 },
  mainButton: { height: 56, borderRadius: 16, alignItems: 'center', justifyContent: 'center' },
  buttonText: { color: '#FFF', fontFamily: 'Syne_700Bold', fontSize: 14, letterSpacing: 1 },
  ...
  successText: { fontFamily: 'Syne_700Bold', fontSize: 14 }
});
